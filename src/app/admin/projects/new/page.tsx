...
export default function NewProjectPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Build project data with proper null handling
      ...
      if (problem.trim()) {
        projectData.problem = problem.trim()
      }
      
      if (solution.trim()) {
        projectData.solution = solution.trim()
      }
      
      if (targetAudience.trim()) {
        projectData.targetAudience = targetAudience.trim()
      }
      
      if (featuresArray.length > 0) {
        projectData.features = featuresArray
      }
      ...
      if (videoUrl.trim()) {
        projectData.videoUrl = videoUrl.trim()
      }
    ...
    <div className="min-h-screen bg-neutral-50">
      ...
      <header className="bg-white border-b border-neutral-200">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-light text-neutral-900">Add New Project</h1>
            <p className="text-sm text-neutral-600">Create a new project showcase</p>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-neutral-50 border border-neutral-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                  placeholder="Create professional resumes in seconds"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-4 py-3 bg-neutral-50 border border-neutral-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                  placeholder="A detailed description of what this project does..."
                />
              </div>
          ...
          {/* Detailed Info */}
          <div className="bg-white rounded-xl border border-neutral-200 p-6">
            <h2 className="text-lg font-medium text-neutral-900 mb-6">Detailed Information (Optional)</h2>
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-neutral-50 border border-neutral-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                  placeholder="Job seekers, recruiters, HR professionals"
                />
              </div>
          ...
          {/* Media Upload */}
          <div className="bg-white rounded-xl border border-neutral-200 p-6">
            <h2 className="text-lg font-medium text-neutral-900 mb-6">Media & Screenshots (Optional)</h2>
            ...
            <div className="space-y-5">
              <div className="flex items-center gap-3">
                ...
                <label htmlFor="featured" className="text-sm font-medium text-neutral-700">
                  Feature this project (show in homepage slider)
                </label>
              </div>
